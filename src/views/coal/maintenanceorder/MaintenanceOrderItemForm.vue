<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      <el-form-item label="检修单ID" prop="orderId">
        <el-input v-model="formData.orderId" placeholder="请输入检修单ID" />
      </el-form-item>
      ...
      <el-form-item label="完成质量" prop="completionQuality">
        <el-select v-model="formData.completionQuality" placeholder="请选择完成质量">
          <el-option
            v-for="dict in getIntDictOptions(DICT_TYPE.COMPLETION_QUALITY)"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
...
/** 检修项目明细 表单 */
defineOptions({ name: 'MaintenanceOrderItemForm' })
